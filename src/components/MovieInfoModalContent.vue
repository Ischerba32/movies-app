    ...
    <div class="movie-info-content">
      <b-row>
        ...
        <b-col sm="8">
          ...
          <div class="mt-3 mb-4">
            <b-badge class="mr-2" variant="warning">{{ movie.Year }}</b-badge>
            <b-badge class="mr-2" variant="warning">{{
              movie.RunTime
            }}</b-badge>
            <b-badge class="mr-2" variant="warning">{{ movie.Genre }}</b-badge>
            <b-badge class="mr-2" variant="warning">{{
              movie.Language
            }}</b-badge>
          </div>
